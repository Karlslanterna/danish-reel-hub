 ...
 *    i.e. cinemas that are NOT linked to an active eBillet organizer.
...
/** True when the cinema is owned by eBillet and therefore off-limits. */
 ...
 *  - its cinema is Kultunaut-authoritative (not eBillet-owned)
