...
/** Same UA policy as the Kultunaut feed: identify ourselves consistently. */
...
export type EbilletPosters = {
  small?: string | null;
  large?: string | null;
  hd?: string | null;
};

export type EbilletMovieBase = {
  id: number;
  name: string;
...
/**
 * Fetch the movie/showtime payload for one or more organizer ids.
...
/** Deep link into eBillet's booking flow for one screening. */
