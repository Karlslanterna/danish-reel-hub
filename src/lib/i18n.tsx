...
const dict = {
  da: {
    ...
    "home.childrenHero": "Børnefilm i biografen",
    "home.childrenSub": "Find aktuelle børnefilm og spilletider i biografer i hele Danmark.",
    "home.movies": "film",
    ...
    "filter.date": "Dato",
    "filter.children": "For børn",
    "filter.time": "Tidspunkt",
    "filter.time.all": "Alle tider",
    "filter.time.morning": "Formiddag",
    "filter.time.afternoon": "Eftermiddag",
    "filter.time.evening": "Aften",
    "filter.time.late": "Sen aften",
    "filter.today": "I dag",
  ...
  en: {
    ...
    "home.childrenHero": "Children's movies in cinemas",
    "home.childrenSub": "Find current children's movies and showtimes in cinemas across Denmark.",
    "home.movies": "movies",
